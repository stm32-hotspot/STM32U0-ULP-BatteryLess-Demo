...
/**
  ...
  * @param   HDPEndPage specifies the end page of the hide protection area
  * @param   HDPEn      specifies the status of the hide protection area (Enabled(other) or diasbled(0xB4))
  * @retval None
  */
static void FLASH_OB_GetHDPConfig(uint32_t *BootEntry, uint32_t *HDPEndPage, uint32_t *HDPEn)
{
...
/**
  ...
  * @retval None
  */
void HAL_FLASHEx_ConfigHDPExtension(FLASH_HDPExtensionTypeDef *pHDPExtension)
{
