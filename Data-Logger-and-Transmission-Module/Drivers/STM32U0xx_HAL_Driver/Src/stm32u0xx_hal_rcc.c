 ...
 * @{
 */
#define LSI_TIMEOUT_VALUE          ((uint32_t)17UL)  /* 17 ms (LSI maximum timeout is LSI startup time + LSI_VALUE/128 when LSI prediv is used) */
...
/*----------------------------- MSI Configuration --------------------------*/
  if(((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_MSI) == RCC_OSCILLATORTYPE_MSI)
  {
    ...
    if((sysclk_source == RCC_SYSCLKSOURCE_STATUS_MSI) ||
       ((sysclk_source == RCC_SYSCLKSOURCE_STATUS_PLLR) && (pll_config == RCC_PLLSOURCE_MSI)))
    {
  ...
  if(((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_HSE) == RCC_OSCILLATORTYPE_HSE)
  {
    ...
    if((__HAL_RCC_GET_SYSCLK_SOURCE() == RCC_SYSCLKSOURCE_STATUS_HSE) ||
       ((__HAL_RCC_GET_SYSCLK_SOURCE() == RCC_SYSCLKSOURCE_STATUS_PLLR) && (__HAL_RCC_GET_PLL_OSCSOURCE() == RCC_PLLSOURCE_HSE)))
    {
  ...
  if(((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_HSI) == RCC_OSCILLATORTYPE_HSI)
  {
    ...
    if((__HAL_RCC_GET_SYSCLK_SOURCE() == RCC_SYSCLKSOURCE_STATUS_HSI) ||
       ((__HAL_RCC_GET_SYSCLK_SOURCE() == RCC_SYSCLKSOURCE_STATUS_PLLR) && (__HAL_RCC_GET_PLL_OSCSOURCE() == RCC_PLLSOURCE_HSI)))
    {
...
/*------------------------------ LSE Configuration -------------------------*/
 ...
 if(((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_HSI48) == RCC_OSCILLATORTYPE_HSI48)
  ...
  if(RCC_OscInitStruct->PLL.PLLState != RCC_PLL_NONE)
  {
    ...
    if(__HAL_RCC_GET_SYSCLK_SOURCE() != RCC_SYSCLKSOURCE_STATUS_PLLR)
    {
...
uint32_t HAL_RCC_GetSysClockFreq(void)
{
  ...
  uint32_t pllsourcefreq = 0U;

  sysclk_source = __HAL_RCC_GET_SYSCLK_SOURCE();
  pll_oscsource = __HAL_RCC_GET_PLL_OSCSOURCE();

  if((sysclk_source == RCC_SYSCLKSOURCE_STATUS_MSI) ||
     ((sysclk_source == RCC_SYSCLKSOURCE_STATUS_PLLR) && (pll_oscsource == RCC_PLLSOURCE_MSI)))
  {
  ...
  if(sysclk_source == RCC_SYSCLKSOURCE_STATUS_PLLR)
  {
...
void HAL_RCC_GetOscConfig(RCC_OscInitTypeDef  *RCC_OscInitStruct)
{
  ...
  {
    if((READ_BIT(RCC->BDCR, RCC_BDCR_LSEON) == RCC_BDCR_LSEON) && (READ_BIT(RCC->BDCR, RCC_BDCR_LSESYSEN) == RCC_BDCR_LSESYSEN))
    {
