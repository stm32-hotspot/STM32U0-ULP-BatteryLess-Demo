...
#define LL_RCC_SYS_CLKSOURCE_PLLR          (RCC_CFGR_SW_1 | RCC_CFGR_SW_0)   /*!< PLL selection as system clock */
...
#define LL_RCC_SYS_CLKSOURCE_STATUS_PLLR   (RCC_CFGR_SWS_1 | RCC_CFGR_SWS_0)  /*!< PLL used as system clock */
...
#define LL_RCC_PLLP_DIV_32                 (RCC_PLLCFGR_PLLP_4|RCC_PLLCFGR_PLLP_3|RCC_PLLCFGR_PLLP_2|RCC_PLLCFGR_PLLP_1|RCC_PLLCFGR_PLLP_0) /*!< Main PLL division factor for PLLP output by 32 */
/**
  * @}
  */
...
/**
  ...
  */
#define __LL_RCC_CALC_PCLK1_FREQ(__HCLKFREQ__, __APBPRESCALER__) ((__HCLKFREQ__) >> APBPrescTable[(__APBPRESCALER__) >>  RCC_CFGR_PPRE_Pos])
...
/**
  * @brief  Enable HSI oscillator
  * @rmtoll CR           HSIASFS         LL_RCC_HSIASFS_Enable
  * @retval None
  */
__STATIC_INLINE uint32_t LL_RCC_HSI_EnableAutoFromStop(void)
{
  return (READ_BIT(RCC->CR, RCC_CR_HSIASFS) == (RCC_CR_HSIASFS));
}

/**
  * @brief  Disable HSI oscillator
  * @rmtoll CR           HSIASFS         LL_RCC_HSIASFS_Disable
  * @retval None
  */
...
/**
  ...
  * @rmtoll CSR          IWDGRSTF      LL_RCC_IsActiveFlag_WDGRST
  * @retval State of bit (1 or 0).
  */
