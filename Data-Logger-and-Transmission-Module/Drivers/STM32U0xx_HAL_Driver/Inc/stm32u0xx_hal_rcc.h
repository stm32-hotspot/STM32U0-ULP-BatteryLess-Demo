...
#define RCC_HSICALIBRATION_DEFAULT     (0x41U)                /*! Default HSI calibration trimming value */
/**
  * @}
  */
...
#define RCC_MSICALIBRATION_DEFAULT     (0x12U)             /*!< Default MSI calibration trimming value */
/**
  * @}
  */
...
#define RCC_SYSCLKSOURCE_STATUS_PLLR     (RCC_CFGR_SWS_1 | RCC_CFGR_SWS_0)  /*!< PLL used as system clock */
...
#define RCC_MCO1_PA9           (RCC_MCO1_INDEX | (GPIO_AF0_MCO << RCC_MCO_GPIOAF_POS) | (GPIO_GET_INDEX(GPIOA) << RCC_MCO_GPIOPORT_POS) | GPIO_PIN_9)
#define RCC_MCO1_PF2           (RCC_MCO1_INDEX | (GPIO_AF0_MCO << RCC_MCO_GPIOAF_POS) | (GPIO_GET_INDEX(GPIOF) << RCC_MCO_GPIOPORT_POS) | GPIO_PIN_2)
#define RCC_MCO1               RCC_MCO1_PA8

#define RCC_MCO2_INDEX         (0x1UL << RCC_MCO_INDEX_POS)             /*!< MCO2 index */
#define RCC_MCO2_PC2           (RCC_MCO2_INDEX | (GPIO_AF0_MCO2 << RCC_MCO_GPIOAF_POS) | (GPIO_GET_INDEX(GPIOC) << RCC_MCO_GPIOPORT_POS) | GPIO_PIN_2)
#define RCC_MCO2_PA10          (RCC_MCO2_INDEX | (GPIO_AF3_MCO2 << RCC_MCO_GPIOAF_POS) | (GPIO_GET_INDEX(GPIOA) << RCC_MCO_GPIOPORT_POS) | GPIO_PIN_10)
#define RCC_MCO2_PA8           (RCC_MCO2_INDEX | (GPIO_AF3_MCO2 << RCC_MCO_GPIOAF_POS) | (GPIO_GET_INDEX(GPIOA) << RCC_MCO_GPIOPORT_POS) | GPIO_PIN_8)
...
/** @defgroup RCC__Peripheral_Clock_Enable_Disable_Status APB Peripheral Clock Enabled or Disabled Status
  ...
  * @{
  */
#define __HAL_RCC_TIM2_IS_CLK_ENABLED()            (READ_BIT(RCC->APBENR1, RCC_APBENR1_TIM2EN) != RESET)

#define __HAL_RCC_TIM3_IS_CLK_ENABLED()            (READ_BIT(RCC->APBENR1, RCC_APBENR1_TIM3EN) != RESET)

#define __HAL_RCC_TIM6_IS_CLK_ENABLED()            (READ_BIT(RCC->APBENR1, RCC_APBENR1_TIM6EN) != RESET)

#define __HAL_RCC_TIM7_IS_CLK_ENABLED()            (READ_BIT(RCC->APBENR1, RCC_APBENR1_TIM7EN) != RESET)

#define __HAL_RCC_LPUART2_IS_CLK_ENABLED()         (READ_BIT(RCC->APBENR1, RCC_APBENR1_LPUART2EN) != RESET)

#if defined (LCD)
#define __HAL_RCC_LCD_IS_CLK_ENABLED()             (READ_BIT(RCC->APBENR1, RCC_APBENR1_LCDEN) != RESET)
#endif /* LCD */

#define __HAL_RCC_RTCAPB_IS_CLK_ENABLED()          (READ_BIT(RCC->APBENR1, RCC_APBENR1_RTCAPBEN) != RESET)

#define __HAL_RCC_WWDG_IS_CLK_ENABLED()            (READ_BIT(RCC->APBENR1, RCC_APBENR1_WWDGEN) != RESET)

#if defined (LPUART3)
#define __HAL_RCC_LPUART3_IS_CLK_ENABLED()         (READ_BIT(RCC->APBENR1, RCC_APBENR1_LPUART3EN) != RESET)
#endif /* LPUART3 */

#if defined (USB_DRD_FS)
#define __HAL_RCC_USB_IS_CLK_ENABLED()             (READ_BIT(RCC->APBENR1, RCC_APBENR1_USBEN) != RESET)
#endif /* USB_DRD_FS */

#define __HAL_RCC_SPI2_IS_CLK_ENABLED()            (READ_BIT(RCC->APBENR1, RCC_APBENR1_SPI2EN) != RESET)

#define __HAL_RCC_SPI3_IS_CLK_ENABLED()            (READ_BIT(RCC->APBENR1, RCC_APBENR1_SPI3EN) != RESET)
#if defined(CRS)
#define __HAL_RCC_CRS_IS_CLK_ENABLED()             (READ_BIT(RCC->APBENR1, RCC_APBENR1_CRSEN) != RESET)
#endif /* CRS */
#define __HAL_RCC_USART2_IS_CLK_ENABLED()          (READ_BIT(RCC->APBENR1, RCC_APBENR1_USART2EN) != RESET)

#define __HAL_RCC_USART3_IS_CLK_ENABLED()          (READ_BIT(RCC->APBENR1, RCC_APBENR1_USART3EN) != RESET)

#define __HAL_RCC_USART4_IS_CLK_ENABLED()          (READ_BIT(RCC->APBENR1, RCC_APBENR1_USART4EN) != RESET)

#define __HAL_RCC_LPUART1_IS_CLK_ENABLED()         (READ_BIT(RCC->APBENR1, RCC_APBENR1_LPUART1EN) != RESET)

#define __HAL_RCC_I2C1_IS_CLK_ENABLED()            (READ_BIT(RCC->APBENR1, RCC_APBENR1_I2C1EN) != RESET)

#define __HAL_RCC_I2C2_IS_CLK_ENABLED()            (READ_BIT(RCC->APBENR1, RCC_APBENR1_I2C2EN) != RESET)

#define __HAL_RCC_I2C3_IS_CLK_ENABLED()            (READ_BIT(RCC->APBENR1, RCC_APBENR1_I2C3EN) != RESET)

#define __HAL_RCC_OPAMP_IS_CLK_ENABLED()           (READ_BIT(RCC->APBENR1, RCC_APBENR1_OPAMPEN) != RESET)
#if defined(I2C4)
#define __HAL_RCC_I2C4_IS_CLK_ENABLED()            (READ_BIT(RCC->APBENR1, RCC_APBENR1_I2C4EN) != RESET)
#endif /* I2C4 */
#if defined (LPTIM3)
#define __HAL_RCC_LPTIM3_IS_CLK_ENABLED()          (READ_BIT(RCC->APBENR1, RCC_APBENR1_LPTIM3EN) != RESET)
#endif /* LPTIM3 */

#define __HAL_RCC_PWR_IS_CLK_ENABLED()             (READ_BIT(RCC->APBENR1, RCC_APBENR1_PWREN) != RESET)

#define __HAL_RCC_DAC1_IS_CLK_ENABLED()            (READ_BIT(RCC->APBENR1, RCC_APBENR1_DAC1EN) != RESET)

#define __HAL_RCC_LPTIM2_IS_CLK_ENABLED()          (READ_BIT(RCC->APBENR1, RCC_APBENR1_LPTIM2EN) != RESET)

#define __HAL_RCC_LPTIM1_IS_CLK_ENABLED()          (READ_BIT(RCC->APBENR1, RCC_APBENR1y_LPTIM1EN) != RESET)

#define __HAL_RCC_TIM2_IS_CLK_DISABLED()           (READ_BIT(RCC->APBENR1, RCC_APBENR1_TIM2EN) == RESET)

#define __HAL_RCC_TIM3_IS_CLK_DISABLED()           (READ_BIT(RCC->APBENR1, RCC_APBENR1_TIM3EN) == RESET)

#define __HAL_RCC_TIM6_IS_CLK_DISABLED()           (READ_BIT(RCC->APBENR1, RCC_APBENR1_TIM6EN) == RESET)

#define __HAL_RCC_TIM7_IS_CLK_DISABLED()           (READ_BIT(RCC->APBENR1, RCC_APBENR1_TIM7EN) == RESET)

#define __HAL_RCC_LPUART2_IS_CLK_DISABLED()        (READ_BIT(RCC->APBENR1, RCC_APBENR1_LPUART2EN) == RESET)

#if defined (LCD)
#define __HAL_RCC_LCD_IS_CLK_DISABLED()            (READ_BIT(RCC->APBENR1, RCC_APBENR1_LCDEN) == RESET)
#endif /* LCD */

#define __HAL_RCC_RTCAPB_IS_CLK_DISABLED()         (READ_BIT(RCC->APBENR1, RCC_APBENR1_RTCAPBEN) == RESET)

#define __HAL_RCC_WWDG_IS_CLK_DISABLED()           (READ_BIT(RCC->APBENR1, RCC_APBENR1_WWDGEN) == RESET)

#if defined (LPUART3)
#define __HAL_RCC_LPUART3_IS_CLK_DISABLED()        (READ_BIT(RCC->APBENR1, RCC_APBENR1_LPUART3EN) == RESET)
#endif /* LPUART3 */

#if defined (USB_DRD_FS)
#define __HAL_RCC_USB_IS_CLK_DISABLED()            (READ_BIT(RCC->APBENR1, RCC_APBENR1_USBEN) == RESET)
#endif /* USB_DRD_FS */

#define __HAL_RCC_SPI2_IS_CLK_DISABLED()           (READ_BIT(RCC->APBENR1, RCC_APBENR1_SPI2EN) == RESET)

#define __HAL_RCC_SPI3_IS_CLK_DISABLED()           (READ_BIT(RCC->APBENR1, RCC_APBENR1_SPI3EN) == RESET)

#define __HAL_RCC_CRS_IS_CLK_DISABLED()            (READ_BIT(RCC->APBENR1, RCC_APBENR1_CRSEN) == RESET)

#define __HAL_RCC_USART2_IS_CLK_DISABLED()         (READ_BIT(RCC->APBENR1, RCC_APBENR1_USART2EN) == RESET)

#define __HAL_RCC_USART3_IS_CLK_DISABLED()         (READ_BIT(RCC->APBENR1, RCC_APBENR1_USART3EN) == RESET)

#define __HAL_RCC_USART4_IS_CLK_DISABLED()         (READ_BIT(RCC->APBENR1, RCC_APBENR1_USART4EN) == RESET)

#define __HAL_RCC_LPUART1_IS_CLK_DISABLED()        (READ_BIT(RCC->APBENR1, RCC_APBENR1_LPUART1EN) == RESET)

#define __HAL_RCC_I2C1_IS_CLK_DISABLED()           (READ_BIT(RCC->APBENR1, RCC_APBENR1_I2C1EN) == RESET)

#define __HAL_RCC_I2C2_IS_CLK_DISABLED()           (READ_BIT(RCC->APBENR1, RCC_APBENR1_I2C2EN) == RESET)

#define __HAL_RCC_I2C3_IS_CLK_DISABLED()           (READ_BIT(RCC->APBENR1, RCC_APBENR1_I2C3EN) == RESET)

#define __HAL_RCC_OPAMP_IS_CLK_DISABLED()          (READ_BIT(RCC->APBENR1, RCC_APBENR1_OPAMPEN) == RESET)

#define __HAL_RCC_I2C4_IS_CLK_DISABLED()           (READ_BIT(RCC->APBENR1, RCC_APBENR1_I2C4EN) == RESET)

#if defined (LPTIM3)
#define __HAL_RCC_LPTIM3_IS_CLK_DISABLED()         (READ_BIT(RCC->APBENR1, RCC_APBENR1_LPTIM3EN) == RESET)
#endif /* LPTIM3 */

#define __HAL_RCC_PWR_IS_CLK_DISABLED()            (READ_BIT(RCC->APBENR1, RCC_APBENR1_PWREN) == RESET)

#define __HAL_RCC_DAC1_IS_CLK_DISABLED()           (READ_BIT(RCC->APBENR1, RCC_APBENR1_DAC1EN) == RESET)

#define __HAL_RCC_LPTIM2_IS_CLK_DISABLED()         (READ_BIT(RCC->APBENR1, RCC_APBENR1_LPTIM2EN) == RESET)

#define __HAL_RCC_LPTIM1_IS_CLK_DISABLED()         (READ_BIT(RCC->APBENR1, RCC_APBENR1_LPTIM1EN) == RESET)
/**
  * @}
  */
...
/** @defgroup RCC_APB_2_Peripheral_Clock_Enable_Disable_Status APB_2 Peripheral Clock Enabled or Disabled Status
  ...
  * @{
  */
#define __HAL_RCC_SYSCFG_IS_CLK_ENABLED()      (READ_BIT(RCC->APBENR2, RCC_APBENR2_SYSCFGEN) != RESET)
...
#define __HAL_RCC_TIM1_IS_CLK_ENABLED()        (READ_BIT(RCC->APBENR2, RCC_APBENR2_TIM1EN)   != RESET)

#define __HAL_RCC_SPI1_IS_CLK_ENABLED()        (READ_BIT(RCC->APBENR2, RCC_APBENR2_SPI1EN)   != RESET)

#define __HAL_RCC_USART1_IS_CLK_ENABLED()      (READ_BIT(RCC->APBENR2, RCC_APBENR2_USART1EN) != RESET)

#define __HAL_RCC_TIM15_IS_CLK_ENABLED()       (READ_BIT(RCC->APBENR2, RCC_APBENR2_TIM15EN)   != RESET)

#define __HAL_RCC_TIM16_IS_CLK_ENABLED()       (READ_BIT(RCC->APBENR2, RCC_APBENR2_TIM16EN)  != RESET)

#define __HAL_RCC_ADC_IS_CLK_ENABLED()         (READ_BIT(RCC->APBENR2, RCC_APBENR2_ADCEN)    != RESET)
...
#define __HAL_RCC_SYSCFG_IS_CLK_DISABLED()     (READ_BIT(RCC->APBENR2, RCC_APBENR2_SYSCFGEN) == RESET)

#define __HAL_RCC_TIM1_IS_CLK_DISABLED()       (READ_BIT(RCC->APBENR2, RCC_APBENR2_TIM1EN)   == RESET)

#define __HAL_RCC_SPI1_IS_CLK_DISABLED()       (READ_BIT(RCC->APBENR2, RCC_APBENR2_SPI1EN)   == RESET)

#define __HAL_RCC_USART1_IS_CLK_DISABLED()     (READ_BIT(RCC->APBENR2, RCC_APBENR2_USART1EN) == RESET)

#define __HAL_RCC_TIM15_IS_CLK_DISABLED()      (READ_BIT(RCC->APBENR2, RCC_APBENR2_TIM15EN)   == RESET)

#define __HAL_RCC_TIM16_IS_CLK_DISABLED()      (READ_BIT(RCC->APBENR2, RCC_APBENR2_TIM16EN)  == RESET)

#define __HAL_RCC_ADC_IS_CLK_DISABLED()        (READ_BIT(RCC->APBENR2, RCC_APBENR2_ADCEN)    == RESET)
...
#define __HAL_RCC_DBGMCU_IS_CLK_ENABLED()      (READ_BIT(RCC->DBGCFGR, RCC_DBGCFGR_DBGEN) != RESET)

#define __HAL_RCC_DBGMCU_CLK_DISABLE()         CLEAR_BIT(RCC->DBGCFGR, RCC_DBGCFGR_DBGEN)

#define __HAL_RCC_DBGMCU_IS_CLK_DISABLED()     (READ_BIT(RCC->DBGCFGR, RCC_DBGCFGR_DBGEN) == RESET)
...
/**
  ...
  *            @arg @ref RCC_PLLRCLK  This Clock is used to generate the high speed system clock (up to 48MHz)
  * @retval None
  */
...
/** @brief  Check whether the selected RCC flag is set or not.
  ...
  *            @arg @ref RCC_FLAG_BORRSTF   BOR reset
  *            @arg @ref RCC_FLAG_OBLRSTF   OBLRST reset
  *            @arg @ref RCC_FLAG_PINRSTF   Pin reset
  *            @arg @ref RCC_FLAG_RMVF      Remove reset Flag
  *            @arg @ref RCC_FLAG_SFTRSTF   Software reset
  *            @arg @ref RCC_FLAG_IWDGRSTF  Independent Watchdog reset
  *            @arg @ref RCC_FLAG_WWDGRSTF  Window Watchdog reset
  *            @arg @ref RCC_FLAG_LPWRRSTF  Low Power reset
