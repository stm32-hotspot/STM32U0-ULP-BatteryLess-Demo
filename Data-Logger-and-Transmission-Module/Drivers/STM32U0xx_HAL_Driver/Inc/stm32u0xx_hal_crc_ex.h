...
/**
  ...
  * @retval None
  */
#define  __HAL_CRC_OUTPUTREVERSAL_BIT_ENABLE(__HANDLE__) MODIFY_REG(((__HANDLE__)->Instance->CR), (CRC_CR_RTYPE_OUT | CRC_CR_REV_OUT), CRC_CR_REV_OUT_0);
...
/**
  ...
  * @retval None
  */
#define  __HAL_CRC_OUTPUTREVERSAL_HALFWORD_ENABLE(__HANDLE__) MODIFY_REG(((__HANDLE__)->Instance->CR), (CRC_CR_RTYPE_OUT | CRC_CR_REV_OUT), (CRC_CR_RTYPE_OUT | CRC_CR_REV_OUT_0));
...
/**
  ...
  * @retval None
  */
#define  __HAL_CRC_OUTPUTREVERSAL_BYTE_ENABLE(__HANDLE__) MODIFY_REG(((__HANDLE__)->Instance->CR), (CRC_CR_RTYPE_OUT | CRC_CR_REV_OUT), (CRC_CR_RTYPE_OUT | CRC_CR_REV_OUT_1));
...
/**
  ...
  * @retval None
  */
#define __HAL_CRC_OUTPUTREVERSAL_DISABLE(__HANDLE__) ((__HANDLE__)->Instance->CR &= ~(CRC_CR_RTYPE_OUT | CRC_CR_REV_OUT))
