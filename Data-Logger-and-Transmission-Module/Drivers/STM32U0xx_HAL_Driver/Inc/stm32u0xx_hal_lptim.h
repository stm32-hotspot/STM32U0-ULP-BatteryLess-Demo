...
#define __HAL_LPTIM_DISABLE(__HANDLE__)                             \
  do {                                                              \
    if (IS_LPTIM_CC4_INSTANCE(hlptim->Instance) == 1UL)             \
    {                                                               \
      if (((hlptim->Instance->CCMR1 & LPTIM_CCMR1_CC1E) == 0UL)     \
          && ((hlptim->Instance->CCMR1 & LPTIM_CCMR1_CC2E) == 0UL)  \
          && ((hlptim->Instance->CCMR2 & LPTIM_CCMR2_CC3E) == 0UL)  \
          && ((hlptim->Instance->CCMR2 & LPTIM_CCMR2_CC4E) == 0UL)) \
      {                                                             \
        CLEAR_BIT(hlptim->Instance->CR, LPTIM_CR_ENABLE);           \
      }                                                             \
    }                                                               \
    else if (IS_LPTIM_CC2_INSTANCE(hlptim->Instance) == 1UL)        \
    {                                                               \
      if (((hlptim->Instance->CCMR1 & LPTIM_CCMR1_CC1E) == 0UL)     \
          && ((hlptim->Instance->CCMR1 & LPTIM_CCMR1_CC2E) == 0UL)) \
      {                                                             \
