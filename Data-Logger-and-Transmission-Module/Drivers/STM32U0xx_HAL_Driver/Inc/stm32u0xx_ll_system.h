...
/** @defgroup SYSTEM_LL_EC_IR_MOD SYSCFG IR Modulation
  * @{
  */
#define LL_SYSCFG_IR_MOD_TIM16       0x00000000U                                        /*!< 00: Timer16 is selected as IRDA Modulation enveloppe source */
...
{
  MODIFY_REG(SYSCFG->CFGR2, SYSCFG_CFGR2_CCL | SYSCFG_CFGR2_SPL | SYSCFG_CFGR2_PVDL | SYSCFG_CFGR2_ECCL | SYSCFG_CFGR2_BKPL, Break);
}
...
{
  return (uint32_t)(READ_BIT(SYSCFG->CFGR2, SYSCFG_CFGR2_CCL | SYSCFG_CFGR2_SPL | SYSCFG_CFGR2_PVDL | SYSCFG_CFGR2_ECCL | SYSCFG_CFGR2_BKPL));
}
...
/**
  ...
  * @rmtoll SYSCFG_TSCCR   G4_IO3      LL_SYSCFG_EnableTSCCmpMod_G4IO3
  * @retval None
  */
__STATIC_INLINE void LL_SYSCFG_EnableTSCCmpMod_G4IO3(void)
{
  SET_BIT(SYSCFG->TSCCR, SYSCFG_TSCCR_G4IO3);
}

/**
  * @brief  Disable connection of PC6 to COMP2
  * @rmtoll SYSCFG_TSCCR   G4_IO3      LL_SYSCFG_DisableTSCCmpMod_G4IO3
  * @retval None
  */
__STATIC_INLINE void LL_SYSCFG_DisableTSCCmpMod_G4IO3(void)
{
  CLEAR_BIT(SYSCFG->TSCCR, SYSCFG_TSCCR_G4IO3);
}
...
/**
  * @brief  Enable connection of PA9 to COMP2
  * @rmtoll SYSCFG_TSCCR   G7_IO1      LL_SYSCFG_EnableTSCCmpMod_G7IO1
  * @retval None
  */
__STATIC_INLINE void LL_SYSCFG_EnableTSCCmpMod_G7IO1(void)
{
  SET_BIT(SYSCFG->TSCCR, SYSCFG_TSCCR_G7IO1);
}

/**
  * @brief  Disable connection of PA9 to COMP2
  * @rmtoll SYSCFG_TSCCR   G7_IO1      LL_SYSCFG_DisableTSCCmpMod_G7IO1
  * @retval None
  */
__STATIC_INLINE void LL_SYSCFG_DisableTSCCmpMod_G7IO1(void)
{
  CLEAR_BIT(SYSCFG->TSCCR, SYSCFG_TSCCR_G7IO1);
}
