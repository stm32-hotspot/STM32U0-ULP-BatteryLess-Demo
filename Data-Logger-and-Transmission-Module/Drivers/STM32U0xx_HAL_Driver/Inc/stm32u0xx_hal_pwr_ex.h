...
typedef struct
{
  uint32_t PVMType;   /*!< PVMType: Specifies which voltage is monitored and against which threshold.
                           ...
                           @arg @ref PWR_PVM_USB Peripheral Voltage Monitoring USB enable: VDDUSB versus 1.2 V (applicable when USB feature is supported).
                           @arg @ref PWR_PVM_ADC Peripheral Voltage Monitoring ADC enable: VDDA versus 1.62 V.
                           @arg @ref PWR_PVM_DAC Peripheral Voltage Monitoring DAC enable: VDDA versus 2.2 V. */
...
#define IS_PWR_FLASH_POWERDOWN(__MODE__)    ((((__MODE__) & (PWR_FLASHPD_LPRUN | PWR_FLASHPD_LPSLEEP | PWR_FLASHPD_STOP)) != 0U) && \
                                             (((__MODE__) & ~(PWR_FLASHPD_LPRUN | PWR_FLASHPD_LPSLEEP | PWR_FLASHPD_STOP)) == 0U))
/**
  * @}
  */
