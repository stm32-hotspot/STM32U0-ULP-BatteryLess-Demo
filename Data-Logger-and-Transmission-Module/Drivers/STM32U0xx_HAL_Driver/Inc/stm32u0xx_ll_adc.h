...
/* Private types -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
//  extern static const uint16_t* const tempsensor_cal1_add;
//  extern static const uint16_t* const tempsensor_cal2_add;
    
//extern uint16_t* tempsensor_cal1_add;
//extern uint16_t* tempsensor_cal2_add;
...
#define TEMPSENSOR_CAL1_ADDR               (tempsensor_cal1_add) /* ((uint16_t*) (0x1FFF75A8UL)) Address of parameter TS_CAL1: On STM32WL,
                                           temperature sensor ADC raw data acquired at temperature  30 DegC
                                           (tolerance: +-5 DegC), Vref+ = 3.3 V (tolerance: +-10 mV). */
#define TEMPSENSOR_CAL2_ADDR               (tempsensor_cal2_add)      /*((uint16_t*) (0x1FFF75C8UL)) Address of parameter TS_CAL2: On STM32WL,
