/**
  ******************************************************************************
  * @file    stm32u083c_discovery_env_sensors.c
  * @author  MCD Application Team
  * @brief   This file provides a set of functions needed to manage the 
  *          environmental sensors mounted on the STM32U083C-DK board (MB1933).
  ******************************************************************************
  * @attention
  *
...
/** @addtogroup STM32U083C_DK STM32U083C-DK
 * @{
 */

/** @defgroup STM32U083C_DK_ENV_SENSORS STM32U083C-DK ENV SENSORS
 * @{
 */

/** @defgroup STM32U083C_DK_ENV_SENSORS_Exported_Variables STM32U083C-DK ENV SENSORS Exported Variables
 * @{
 */
...
/** @defgroup STM32U083C_DK_ENV_SENSORS_Private_Variables STM32U083C-DK ENV SENSORS Private Variables
 * @{
 */
...
/** @defgroup STM32U083C_DK_ENV_SENSORS_Private_Function_Prototypes STM32U083C-DK ENV SENSORS Private Function Prototypes
 * @{
 */
...
/** @defgroup STM32U083C_DK_ENV_SENSORS_Exported_Functions STM32U083C-DK ENV SENSORS Exported Functions
 * @{
 */
...
/** @defgroup STM32U083C_DK_ENV_SENSORS_Private_Functions STM32U083C-DK ENV SENSORS Private Functions
 * @{
 */
...
static int32_t STTS22H_0_Probe(uint32_t Functions)
{
  ...
  io_ctx.Init        = STM32U083C_DK_I2C_Init;
  io_ctx.DeInit      = STM32U083C_DK_I2C_DeInit;
  io_ctx.ReadReg     = STM32U083C_DK_I2C_ReadReg;
  io_ctx.WriteReg    = STM32U083C_DK_I2C_WriteReg;
  io_ctx.GetTick     = STM32U083C_DK_GetTick;
