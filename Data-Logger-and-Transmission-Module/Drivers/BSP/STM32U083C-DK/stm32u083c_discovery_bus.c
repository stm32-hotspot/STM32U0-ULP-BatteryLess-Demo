/**
  ******************************************************************************
  * @file    stm32u083c_discovery_bus.c
  * @author  MCD Application Team
  * @brief   This file provides a set of firmware functions to manage bus
  *          available on STM32U083C-DK board (MB1933) from
  *          STMicroelectronics.
  ******************************************************************************
  * @attention
  *
...
/** @defgroup STM32U083C_DK_BUS STM32U083C-DK BUS
  * @{
  */

/** @defgroup STM32U083C_DK_BUS_Private_Defines STM32U083C-DK BUS Private Defines
  * @{
  */
...
/** @defgroup STM32U083C_DK_BUS_Private_Types STM32U083C-DK BUS Private Types
  * @{
  */
typedef struct
{
...
/** @defgroup STM32U083C_DK_BUS_Private_Constants STM32U083C-DK BUS Private Constants
  * @{
  */
...
/** @defgroup STM32U083C_DK_BUS_Private_Variables STM32U083C-DK BUS Private Variables
  * @{
  */
...
/** @defgroup STM32U083C_DK_BUS_Exported_Variables STM32U083C-DK BUS Exported Variables
  * @{
  */
...
/** @defgroup STM32U083C_DK_BUS_Private_Function_Prototypes STM32U083C-DK BUS Private Function Prototypes
  * @{
  */
...
/** @defgroup STM32U083C_DK_BUS_Exported_Functions STM32U083C-DK BUS Exported Functions
  * @{
  */
...
//#endif
//      
//#if ((USE_HAL_I2C_REGISTER_CALLBACKS == 0) && (CLOCK_CONFIG < RCC_MSIRANGE_10))
//      uint32_t timing = 0; //I2C_GetTiming(HAL_RCCEx_GetPeriphCLKFreq(RCC_PERIPHCLK_I2C1), BUS_I2C1_FREQUENCY);
//      if (MX_I2C1_Init(&hbus_i2c1, timing) != HAL_OK)
//#else
//      uint32_t timing = 0x20303E5D;
//      if (MX_I2C1_Init(&hbus_i2c1, timing) != HAL_OK)
...
//      uint32_t timing = I2C_GetTiming(HAL_RCCEx_GetPeriphCLKFreq(RCC_PERIPHCLK_I2C1), BUS_I2C1_FREQUENCY);
...
//    if (MX_SPI1_Init(&hbus_spi1, 0U) != HAL_OK) //SPI_GetPrescaler( HAL_RCC_GetPCLK1Freq(), BUS_SPI1_BAUDRATE)) != HAL_OK)
    {
...
//  phspi->Init.CLKPolarity       = SPI_POLARITY_HIGH;
...
#elif (MSI_RANGE == RCC_MSIRANGE_8)
  phspi->Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_2;
#elif (MSI_RANGE == RCC_MSIRANGE_9)
  phspi->Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_4;
#elif (MSI_RANGE == RCC_MSIRANGE_11)
  ...
  phspi->Init.NSSPMode          = SPI_NSS_PULSE_ENABLE; //
...
static void SPI1_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  */
  ...
  /* configure SPIx MISO, MOSI, SCK */
  GPIO_InitStructure.Pin          = BUS_SPI1_MISO_PIN;
...
//  GPIO_InitStructure.Pull      = GPIO_PULLDOWN;
  ...
  GPIO_InitStructure.Speed     = GPIO_SPEED_FREQ_LOW;
  GPIO_InitStructure.Alternate = BUS_SPI1_AF;
  HAL_GPIO_Init(BUS_SPI1_GPIO_PORTB, &GPIO_InitStructure);
...
/** @defgroup STM32U083C_DK_BUS_Private_Functions STM32U083C-DK BUS Private Functions
  * @{
  */
