/**
  ******************************************************************************
  * @file    stm32u083c_discovery_glass_lcd.h
  * @author  MCD Application Team
  * @brief   Header file for stm32u083c_discovery_glass_lcd.c module.
  ******************************************************************************
  * @attention
  *
...
#ifndef STM32U083C_DK_GLASS_LCD_H
#define STM32U083C_DK_GLASS_LCD_H
...
/** @addtogroup STM32U083C_DK_GLASS_LCD
  * @{
  */

/* Exported types ------------------------------------------------------------*/

/** @defgroup STM32U083C_DK_GLASS_LCD_Exported_Types Exported Types
  * @{
  */
/**
...
/** @defgroup STM32U083C_DK_GLASS_LCD_Exported_Constants Exported Constants
  * @{
*/
/**
...
#define LCD_DIGIT1_COM0_SEG_MASK      ~(LCD_SEG0 | LCD_SEG1)
#define LCD_DIGIT1_COM0_1             LCD_COM0_1
#define LCD_DIGIT1_COM0_1_SEG_MASK    ~(LCD_SEG22 | LCD_SEG23)

#define LCD_DIGIT1_COM1               LCD_COM1
#define LCD_DIGIT1_COM1_SEG_MASK      ~(LCD_SEG0 | LCD_SEG1)
#define LCD_DIGIT1_COM1_1             LCD_COM1_1
#define LCD_DIGIT1_COM1_1_SEG_MASK    ~(LCD_SEG22 | LCD_SEG23)


#define LCD_DIGIT1_COM2               LCD_COM2
#define LCD_DIGIT1_COM2_SEG_MASK      ~(LCD_SEG0 | LCD_SEG1)
#define LCD_DIGIT1_COM2_1             LCD_COM2_1
#define LCD_DIGIT1_COM2_1_SEG_MASK    ~(LCD_SEG22 | LCD_SEG23)


#define LCD_DIGIT1_COM3               LCD_COM3
#define LCD_DIGIT1_COM3_SEG_MASK      ~(LCD_SEG0 | LCD_SEG1)
#define LCD_DIGIT1_COM3_1             LCD_COM3_1
#define LCD_DIGIT1_COM3_1_SEG_MASK    ~(LCD_SEG22 | LCD_SEG23)
#else
#define LCD_DIGIT1_COM0               LCD_COM0
#define LCD_DIGIT1_COM0_SEG_MASK      ~(LCD_SEG0 | LCD_SEG1 | LCD_SEG23)
#define LCD_DIGIT1_COM0_1             LCD_COM0_1
#define LCD_DIGIT1_COM0_1_SEG_MASK    ~(LCD_SEG22)

#define LCD_DIGIT1_COM1               LCD_COM1
#define LCD_DIGIT1_COM1_SEG_MASK      ~(LCD_SEG0 | LCD_SEG1 | LCD_SEG23)
#define LCD_DIGIT1_COM1_1             LCD_COM1_1
#define LCD_DIGIT1_COM1_1_SEG_MASK    ~(LCD_SEG22)


#define LCD_DIGIT1_COM2               LCD_COM2
#define LCD_DIGIT1_COM2_SEG_MASK      ~(LCD_SEG0 | LCD_SEG1 | LCD_SEG23)
#define LCD_DIGIT1_COM2_1             LCD_COM2_1
#define LCD_DIGIT1_COM2_1_SEG_MASK    ~(LCD_SEG22)


#define LCD_DIGIT1_COM3               LCD_COM3
#define LCD_DIGIT1_COM3_SEG_MASK      ~(LCD_SEG0 | LCD_SEG1 | LCD_SEG23)
#define LCD_DIGIT1_COM3_1             LCD_COM3_1
#define LCD_DIGIT1_COM3_1_SEG_MASK    ~(LCD_SEG22)
#endif /* USE_STM32U083C_DISCO_REVB */



#define LCD_DIGIT2_COM0               LCD_COM0
#define LCD_DIGIT2_COM0_SEG_MASK      ~(LCD_SEG2)
#define LCD_DIGIT2_COM0_1             LCD_COM0_1
#define LCD_DIGIT2_COM0_1_SEG_MASK    ~(LCD_SEG3 | LCD_SEG20 | LCD_SEG21)


#define LCD_DIGIT2_COM1               LCD_COM1
#define LCD_DIGIT2_COM1_SEG_MASK      ~(LCD_SEG2)
#define LCD_DIGIT2_COM1_1             LCD_COM1_1
#define LCD_DIGIT2_COM1_1_SEG_MASK    ~(LCD_SEG3 | LCD_SEG20 | LCD_SEG21)


#define LCD_DIGIT2_COM2               LCD_COM2
#define LCD_DIGIT2_COM2_SEG_MASK      ~(LCD_SEG2)
#define LCD_DIGIT2_COM2_1             LCD_COM2_1
#define LCD_DIGIT2_COM2_1_SEG_MASK    ~(LCD_SEG3 | LCD_SEG20 | LCD_SEG21)


#define LCD_DIGIT2_COM3               LCD_COM3
#define LCD_DIGIT2_COM3_SEG_MASK      ~(LCD_SEG2)
#define LCD_DIGIT2_COM3_1             LCD_COM3_1
#define LCD_DIGIT2_COM3_1_SEG_MASK    ~(LCD_SEG3 | LCD_SEG20 | LCD_SEG21)




#define LCD_DIGIT3_COM0_1               LCD_COM0_1
#define LCD_DIGIT3_COM0_1_SEG_MASK      ~(LCD_SEG4 | LCD_SEG5 | LCD_SEG18 | LCD_SEG19)

#define LCD_DIGIT3_COM1_1               LCD_COM1_1
#define LCD_DIGIT3_COM1_1_SEG_MASK      ~(LCD_SEG4 | LCD_SEG5 | LCD_SEG18 | LCD_SEG19)

#define LCD_DIGIT3_COM2_1               LCD_COM2_1
#define LCD_DIGIT3_COM2_1_SEG_MASK      ~(LCD_SEG4 | LCD_SEG5 | LCD_SEG18 | LCD_SEG19)

#define LCD_DIGIT3_COM3_1               LCD_COM3_1
#define LCD_DIGIT3_COM3_1_SEG_MASK      ~(LCD_SEG4 | LCD_SEG5 | LCD_SEG18 | LCD_SEG19)

#if defined (USE_STM32U083C_DISCO_REVB)
#define LCD_DIGIT4_COM0               LCD_COM0
#define LCD_DIGIT4_COM0_SEG_MASK      ~(LCD_SEG6 |LCD_SEG7)
#define LCD_DIGIT4_COM0_1             LCD_COM0_1
#define LCD_DIGIT4_COM0_1_SEG_MASK    ~( LCD_SEG17 | LCD_SEG16)

#define LCD_DIGIT4_COM1               LCD_COM1
#define LCD_DIGIT4_COM1_SEG_MASK      ~(LCD_SEG6 |LCD_SEG7)
#define LCD_DIGIT4_COM1_1             LCD_COM1_1
#define LCD_DIGIT4_COM1_1_SEG_MASK    ~( LCD_SEG17 | LCD_SEG16)

#define LCD_DIGIT4_COM2               LCD_COM2
#define LCD_DIGIT4_COM2_SEG_MASK      ~(LCD_SEG6 |LCD_SEG7)
#define LCD_DIGIT4_COM2_1             LCD_COM2_1
#define LCD_DIGIT4_COM2_1_SEG_MASK    ~( LCD_SEG17 | LCD_SEG16)

#define LCD_DIGIT4_COM3               LCD_COM3
#define LCD_DIGIT4_COM3_SEG_MASK      ~(LCD_SEG6 |LCD_SEG7)
#define LCD_DIGIT4_COM3_1             LCD_COM3_1
#define LCD_DIGIT4_COM3_1_SEG_MASK    ~( LCD_SEG17 | LCD_SEG16)
#else
#define LCD_DIGIT4_COM0               LCD_COM0
#define LCD_DIGIT4_COM0_SEG_MASK      ~(LCD_SEG6 |LCD_SEG7 | LCD_SEG16)
#define LCD_DIGIT4_COM0_1             LCD_COM0_1
#define LCD_DIGIT4_COM0_1_SEG_MASK    ~( LCD_SEG17)

#define LCD_DIGIT4_COM1               LCD_COM1
#define LCD_DIGIT4_COM1_SEG_MASK      ~(LCD_SEG6 |LCD_SEG7 | LCD_SEG16)
#define LCD_DIGIT4_COM1_1             LCD_COM1_1
#define LCD_DIGIT4_COM1_1_SEG_MASK    ~( LCD_SEG17)

#define LCD_DIGIT4_COM2               LCD_COM2
#define LCD_DIGIT4_COM2_SEG_MASK      ~(LCD_SEG6 |LCD_SEG7 | LCD_SEG16)
#define LCD_DIGIT4_COM2_1             LCD_COM2_1
#define LCD_DIGIT4_COM2_1_SEG_MASK    ~( LCD_SEG17)

#define LCD_DIGIT4_COM3               LCD_COM3
#define LCD_DIGIT4_COM3_SEG_MASK      ~(LCD_SEG6 |LCD_SEG7 | LCD_SEG16)
#define LCD_DIGIT4_COM3_1             LCD_COM3_1
#define LCD_DIGIT4_COM3_1_SEG_MASK    ~( LCD_SEG17)
#endif /* USE_STM32U083C_DISCO_REVB */


#define LCD_DIGIT5_COM0               LCD_COM0
#define LCD_DIGIT5_COM0_SEG_MASK      ~(LCD_SEG9 | LCD_SEG14 |LCD_SEG8 | LCD_SEG15)

#define LCD_DIGIT5_COM1               LCD_COM1
#define LCD_DIGIT5_COM1_SEG_MASK      ~(LCD_SEG9 | LCD_SEG14 |LCD_SEG8 | LCD_SEG15)

#define LCD_DIGIT5_COM2               LCD_COM2
#define LCD_DIGIT5_COM2_SEG_MASK      ~(LCD_SEG9 | LCD_SEG14 |LCD_SEG8 | LCD_SEG15)

#define LCD_DIGIT5_COM3               LCD_COM3
#define LCD_DIGIT5_COM3_SEG_MASK      ~(LCD_SEG9 | LCD_SEG14 |LCD_SEG8 | LCD_SEG15)


#define LCD_DIGIT6_COM0               LCD_COM0
#define LCD_DIGIT6_COM0_SEG_MASK      ~(LCD_SEG10 |  LCD_SEG13)
#define LCD_DIGIT6_COM0_1             LCD_COM0_1
#define LCD_DIGIT6_COM0_1_SEG_MASK      ~(LCD_SEG11 | LCD_SEG12 )


#define LCD_DIGIT6_COM1               LCD_COM1
#define LCD_DIGIT6_COM1_SEG_MASK      ~(LCD_SEG10 | LCD_SEG13)
#define LCD_DIGIT6_COM1_1             LCD_COM1_1
#define LCD_DIGIT6_COM1_1_SEG_MASK    ~(LCD_SEG11 | LCD_SEG12 )


#define LCD_DIGIT6_COM2               LCD_COM2
#define LCD_DIGIT6_COM2_SEG_MASK      ~(LCD_SEG10  | LCD_SEG13)
#define LCD_DIGIT6_COM2_1             LCD_COM2_1
#define LCD_DIGIT6_COM2_1_SEG_MASK    ~(LCD_SEG11 | LCD_SEG12 )

#define LCD_DIGIT6_COM3               LCD_COM3
#define LCD_DIGIT6_COM3_SEG_MASK      ~(LCD_SEG10 | LCD_SEG13)
#define LCD_DIGIT6_COM3_1             LCD_COM3_1
#define LCD_DIGIT6_COM3_1_SEG_MASK    ~(LCD_SEG11 | LCD_SEG12 )


/**
  * @brief LCD Bar location
  */
#define LCD_BAR0_COM              LCD_COM3_1
#define LCD_BAR1_COM              LCD_COM2_1
#define LCD_BAR2_COM              LCD_COM3
#define LCD_BAR3_COM              LCD_COM2
#define LCD_BAR0_SEG              LCD_SEG11
#define LCD_BAR1_SEG              LCD_SEG11
#define LCD_BAR2_SEG              LCD_SEG9
#define LCD_BAR3_SEG              LCD_SEG9
#define LCD_BAR0_SEG_MASK       ~(LCD_BAR0_SEG)
#define LCD_BAR1_SEG_MASK       ~(LCD_BAR1_SEG)
...
#else
#define LCD_COM0          MCU_LCD_COM4
#define LCD_COM0_1        MCU_LCD_COM4_1
#define LCD_COM1          MCU_LCD_COM5
#define LCD_COM1_1        MCU_LCD_COM5_1
#define LCD_COM2          MCU_LCD_COM6
#define LCD_COM2_1        MCU_LCD_COM6_1
#define LCD_COM3          MCU_LCD_COM7
#define LCD_COM3_1        MCU_LCD_COM7_1
#endif /* USE_STM32U083C_DISCO_REVB */

#define LCD_SEG0          MCU_LCD_SEG22
#define LCD_SEG1          MCU_LCD_SEG23
#define LCD_SEG2          MCU_LCD_SEG6
#define LCD_SEG3          MCU_LCD_SEG45
#define LCD_SEG4          MCU_LCD_SEG46
#define LCD_SEG5          MCU_LCD_SEG47
#define LCD_SEG6          MCU_LCD_SEG11
#define LCD_SEG7          MCU_LCD_SEG14
#define LCD_SEG8          MCU_LCD_SEG15
#define LCD_SEG9          MCU_LCD_SEG28
#define LCD_SEG10         MCU_LCD_SEG29
#define LCD_SEG11         MCU_LCD_SEG32
#define LCD_SEG12         MCU_LCD_SEG33
#define LCD_SEG13         MCU_LCD_SEG24
#define LCD_SEG14         MCU_LCD_SEG26
#define LCD_SEG15         MCU_LCD_SEG27
#if defined (USE_STM32U083C_DISCO_REVB)
#define LCD_SEG16         MCU_LCD_SEG48
#else
#define LCD_SEG16         MCU_LCD_SEG17
#endif /* USE_STM32U083C_DISCO_REVB */
#define LCD_SEG17         MCU_LCD_SEG34
#define LCD_SEG18         MCU_LCD_SEG35
#define LCD_SEG19         MCU_LCD_SEG36
#define LCD_SEG20         MCU_LCD_SEG37
#define LCD_SEG21         MCU_LCD_SEG38
#define LCD_SEG22         MCU_LCD_SEG39
#if defined (USE_STM32U083C_DISCO_REVB)
#define LCD_SEG23         MCU_LCD_SEG49
#else
#define LCD_SEG23         MCU_LCD_SEG21
#endif /* USE_STM32U083C_DISCO_REVB */
#define LCD_SEG0_SHIFT          MCU_LCD_SEG22_SHIFT
#define LCD_SEG1_SHIFT          MCU_LCD_SEG23_SHIFT
#define LCD_SEG2_SHIFT          MCU_LCD_SEG6_SHIFT
#define LCD_SEG3_SHIFT          MCU_LCD_SEG45_SHIFT
#define LCD_SEG4_SHIFT          MCU_LCD_SEG46_SHIFT
#define LCD_SEG5_SHIFT          MCU_LCD_SEG47_SHIFT
#define LCD_SEG6_SHIFT          MCU_LCD_SEG11_SHIFT
#define LCD_SEG7_SHIFT          MCU_LCD_SEG14_SHIFT
#define LCD_SEG8_SHIFT          MCU_LCD_SEG15_SHIFT
#define LCD_SEG9_SHIFT          MCU_LCD_SEG28_SHIFT
#define LCD_SEG10_SHIFT         MCU_LCD_SEG29_SHIFT
#define LCD_SEG11_SHIFT         MCU_LCD_SEG32_SHIFT
#define LCD_SEG12_SHIFT         MCU_LCD_SEG33_SHIFT
#define LCD_SEG13_SHIFT         MCU_LCD_SEG24_SHIFT
#define LCD_SEG14_SHIFT         MCU_LCD_SEG26_SHIFT
#define LCD_SEG15_SHIFT         MCU_LCD_SEG27_SHIFT
#if defined (USE_STM32U083C_DISCO_REVB)
#define LCD_SEG16_SHIFT         MCU_LCD_SEG48_SHIFT
#else
#define LCD_SEG16_SHIFT         MCU_LCD_SEG17_SHIFT
#endif /* USE_STM32U083C_DISCO_REVB */
#define LCD_SEG17_SHIFT         MCU_LCD_SEG34_SHIFT
#define LCD_SEG18_SHIFT         MCU_LCD_SEG35_SHIFT
#define LCD_SEG19_SHIFT         MCU_LCD_SEG36_SHIFT
#define LCD_SEG20_SHIFT         MCU_LCD_SEG37_SHIFT
#define LCD_SEG21_SHIFT         MCU_LCD_SEG38_SHIFT
#define LCD_SEG22_SHIFT         MCU_LCD_SEG39_SHIFT
#if defined (USE_STM32U083C_DISCO_REVB)
#define LCD_SEG23_SHIFT         MCU_LCD_SEG49_SHIFT
#else
#define LCD_SEG23_SHIFT         MCU_LCD_SEG21_SHIFT
#endif /* USE_STM32U083C_DISCO_REVB */
...
#define MCU_LCD_SEG39         (1U << MCU_LCD_SEG39_SHIFT)
#define MCU_LCD_SEG40         (1U << MCU_LCD_SEG40_SHIFT)
#define MCU_LCD_SEG41         (1U << MCU_LCD_SEG41_SHIFT)
#define MCU_LCD_SEG42         (1U << MCU_LCD_SEG42_SHIFT)
#define MCU_LCD_SEG43         (1U << MCU_LCD_SEG43_SHIFT)
#define MCU_LCD_SEG44         (1U << MCU_LCD_SEG44_SHIFT)
#define MCU_LCD_SEG45         (1U << MCU_LCD_SEG45_SHIFT)
#define MCU_LCD_SEG46         (1U << MCU_LCD_SEG46_SHIFT)
#define MCU_LCD_SEG47         (1U << MCU_LCD_SEG47_SHIFT)
#if defined (USE_STM32U083C_DISCO_REVB)
#define MCU_LCD_SEG48         (1U << MCU_LCD_SEG48_SHIFT)
#define MCU_LCD_SEG49         (1U << MCU_LCD_SEG49_SHIFT)
#endif /* USE_STM32U083C_DISCO_REVB */
...
#define MCU_LCD_SEG45_SHIFT   13
#define MCU_LCD_SEG46_SHIFT   14
#define MCU_LCD_SEG47_SHIFT   15
#if defined (USE_STM32U083C_DISCO_REVB)
#define MCU_LCD_SEG48_SHIFT   16
#define MCU_LCD_SEG49_SHIFT   17
#endif /* USE_STM32U083C_DISCO_REVB */
...
#define LCD_GPIO_BANKB_PINS  (GPIO_PIN_1  | GPIO_PIN_9  | GPIO_PIN_11 |   \
                              GPIO_PIN_14 | GPIO_PIN_15)
#define LCD_GPIO_BANKC_PINS  (GPIO_PIN_3  | GPIO_PIN_4  | GPIO_PIN_5  |   \
                              GPIO_PIN_6  | GPIO_PIN_8  | GPIO_PIN_9  |   \
                              GPIO_PIN_10 | GPIO_PIN_11)
#define LCD_GPIO_BANKD_PINS  (GPIO_PIN_0  | GPIO_PIN_1  | GPIO_PIN_3  |   \
                              GPIO_PIN_4  | GPIO_PIN_5  | GPIO_PIN_6  |   \
                              GPIO_PIN_8  | GPIO_PIN_9  | GPIO_PIN_12 |   \
                              GPIO_PIN_13)
#define LCD_GPIO_BANKE_PINS  (GPIO_PIN_7  | GPIO_PIN_8  | GPIO_PIN_9)
#else
#define LCD_GPIO_BANKA_PINS  (GPIO_PIN_15)
#define LCD_GPIO_BANKB_PINS  (GPIO_PIN_1  | GPIO_PIN_7  | GPIO_PIN_11 |   \
                              GPIO_PIN_14 | GPIO_PIN_15)
#define LCD_GPIO_BANKC_PINS  (GPIO_PIN_3  | GPIO_PIN_4  | GPIO_PIN_5  |   \
                              GPIO_PIN_6  | GPIO_PIN_8  | GPIO_PIN_9  |   \
                              GPIO_PIN_10 | GPIO_PIN_11 | GPIO_PIN_12)
#define LCD_GPIO_BANKD_PINS  (GPIO_PIN_0  | GPIO_PIN_1  | GPIO_PIN_2  |   \
...
/** @defgroup STM32U083C_DK_LCD_Exported_Functions Exported Functions
  * @{
  */
...
#endif /* STM32U083C_DK_GLASS_LCD_H */
