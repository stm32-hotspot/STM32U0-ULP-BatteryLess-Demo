...
#if (INIT_SPEED_CLOCK==RCC_MSIRANGE_11)
  uint32_t SystemCoreClock = 48000000U;
#elif (INIT_SPEED_CLOCK==RCC_MSIRANGE_10)
  uint32_t SystemCoreClock = 32000000U;
#elif (INIT_SPEED_CLOCK==RCC_MSIRANGE_9)
  uint32_t SystemCoreClock = 24000000U;
#elif (INIT_SPEED_CLOCK==RCC_MSIRANGE_8)
  uint32_t SystemCoreClock = 16000000U;
#elif (INIT_SPEED_CLOCK==RCC_MSIRANGE_7)
  uint32_t SystemCoreClock = 8000000U;  
#elif (INIT_SPEED_CLOCK==RCC_MSIRANGE_6)
  uint32_t SystemCoreClock = 4000000U;  
#elif (INIT_SPEED_CLOCK==RCC_MSIRANGE_5)
  uint32_t SystemCoreClock = 2000000U;  
#elif (INIT_SPEED_CLOCK==RCC_MSIRANGE_4)
  uint32_t SystemCoreClock = 1000000U;  
#elif (INIT_SPEED_CLOCK==RCC_MSIRANGE_3)
  uint32_t SystemCoreClock = 800000U;  
#elif (INIT_SPEED_CLOCK==RCC_MSIRANGE_2)
  uint32_t SystemCoreClock = 400000U;  
#elif (INIT_SPEED_CLOCK==RCC_MSIRANGE_1)
  uint32_t SystemCoreClock = 200000U;  
#elif (INIT_SPEED_CLOCK==RCC_MSIRANGE_0)
  uint32_t SystemCoreClock = 100000U;  
#endif
