...
//  uint8_t  dest_addr;
  ...
  MeasuredDataTypeDef MeasuredData;
...
//      }
      if(xRxFrame.Cmd == NEW_DATA_CMD)
      {
//        uint16_t calculated_illuminance = (xTxFrame.DataBuff[1]<<8)|(xTxFrame.DataBuff[0]);
//        uint16_t  calculated_temp = (xTxFrame.DataBuff[3]<<8)|(xTxFrame.DataBuff[2]);
        
//        MeasuredData.lux = (xTxFrame.DataBuff[1]<<8)|(xTxFrame.DataBuff[0]);
//        MeasuredData.temp = (xTxFrame.DataBuff[3]<<8)|(xTxFrame.DataBuff[2]);
        MeasuredData.lux = (pRxBuff[2]<<8)|(pRxBuff[1]);
        MeasuredData.temp = (pRxBuff[4]<<8)|(pRxBuff[3]);
        MeasuredData.new_data_flag =1;
